...
function page() {
  return (
    <section className="">
      <div className="flex flex-col border-x mx-2 border-black min-h-screen pr-10">
        <div className="mx-auto flex flex-col h-screen justify-center w-full">
          <div className="flex flex-col">
            <span className="lg:ml-96 mt-20 text-5xl font-medium">
              Stimulating growth for ambitious brands.
            </span>
            <div className="border-b border-black lg:mt-6 lg:mb-20" />
            <span className="lg:ml-96 text-2xl font-normal ">
              We deliver inspirational brand experiences. Together, let’s unlock
              growth!
            </span>
            <span className="lg:ml-96 text-2xl font-normal lg:mt-10">
              Together, let’s unlock growth!
            </span>
            <button className="lg:ml-96 text-lg font-normal lg:mt-10 border border-black mx-auto px-4 py-2 flex flex-row gap-x-2 items-center">
      ...
      <div className="flex flex-col border-x mx-2 border-black min-h-screen gap-y-8 pr-10">
        ...
        <button className="lg:ml-96 text-lg font-normal lg:mt-5 border border-black mx-auto px-4 py-2 flex flex-row gap-x-2 items-center">
          Know our expertise <BsArrowRight />
        </button>
      </div>
      <div className="bg-purple-950 h-[80vh]"></div>
      <div className="flex flex-col border-x mx-2 border-black  gap-y-8 pr-10">
        <span className="lg:text-3xl font-medium lg:mt-20 lg:ml-96">
          At Creative Dugout, our work principles act as a layer of protection
          for our clients.
        </span>
        <span className="text-2xl lg:ml-96">
      ...
      <div className="flex flex-col border-x mx-2 border-black min-h-screen gap-y-8 pr-10">
        ...
        <div className="lg:ml-96 mt-20">
          <div className="grid grid-cols-2 gap-4 ">
            {team_info.map((info) => (
              <div className="flex flex-row" key={info.key}>
